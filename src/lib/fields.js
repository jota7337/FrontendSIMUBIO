...
export const camposOtros = [
    ...
    {
        label: "Elevación mínima en metros",
        name: "minimumElevationInMeters",
        type: "number",
        help: "Elevación mínima en metros.",
    },
    {
        label: "Elevación máxima en metros",
        name: "maximumElevationInMeters",
        type: "number",
        help: "Elevación máxima en metros.",
    },
    // { label: "Datum vertical", name: "verticalDatum" },
    {
        label: "Profundidad original",
        name: "verbatimDepth",
        type: "number",
        help: "Profundidad registrada originalmente (si aplica).",
    },
    {
        label: "Profundidad mínima en metros",
        name: "minimumDepthInMeters",
        type: "number",
        help: "Profundidad mínima en metros.",
    },
    {
        label: "Profundidad máxima en metros",
        name: "maximumDepthInMeters",
        type: "number",
        help: "Profundidad máxima en metros.",
    },
    ...
    {
        label: "Longitud original",
        name: "verbatimLongitude",
        type: "text",
        help: "Longitud tal como fue registrada originalmente.",
    },
