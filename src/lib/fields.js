...
// Este array se llenará dinámicamente con las referencias obtenidas de la API
...
export const camposEvento = [
    { label: "Número de colector", name: "recordNumber" },
    ...
    },
    {
        ...
        name: "reference_by",
        type: "select",
        options: referencias.map((ref) => ref.referencia),
    },
    ...
    { label: "Sexo", name: "sex", type: "select", options: ["Macho", "Hembra", "Hermafrodita", "Desconocido"] },
    ...
    { label: "Comentario del registro biológico", name: "occurrenceRemarks" },
