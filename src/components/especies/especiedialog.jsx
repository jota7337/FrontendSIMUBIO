...
const SpeciesDetailsDialog = ({ isOpen, onClose, species }) => {
    ...
    return (
        <dialog ref={dialogRef} className="rounded-lg p-0 w-full max-w-3xl bg-white shadow-lg" onClose={onClose}>
            <div className="p-6">
                ...
                <div className="mt-4">
                    ...
                    <p>
                        <span className="font-semibold">Base del registro: </span>
                        {species.base}
                    </p>
                </div>
                <div className="mt-4">
                    ...
                    <p>
                        <span className="font-semibold">Reino: </span>
                ...
                <div className="mt-4">
                    ...
                    <p>
                        <span className="font-semibold">País o área: </span>
                        {species.pais}
                    </p>
                    <p>
